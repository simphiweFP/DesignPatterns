using DesignsPattern.Creatinal.Builder.Director;
...
namespace DesignsPattern.Creatinal.Builder
{
    public class Builder
    {
        ...
        public void Run(string policyType)
        {
            ...
            {
                case "Comprehensive":
                    InsurancePolicy comprehensivePolicy = director.ConstructCarPolicy(builder);
                    _output.Display(comprehensivePolicy.ToString());
                    break;
                case "Family":
                    InsurancePolicy basicPolicy = director.ConstructFuneralPolicy(builder);
                    _output.Display(basicPolicy.ToString());
                    break;
                case "All":
                    InsurancePolicy basicPolic = director.ConstructHealthFPolicy(builder);
                    _output.Display(basicPolic.ToString());
                    break;
                default:
